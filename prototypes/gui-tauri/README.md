...
4. System: load native version, architecture, display/HDR, hardware acceleration, browser, desktop session, and unmapped gamepad information for the Help/About dialog.
